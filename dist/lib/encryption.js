...
export const ENCRYPTION_KEY = process.env.CLIENT_IP_ENCRYPTION_KEY ||
...
export function encryptClientIp(clientIp) {
...
export function generateHeaders(clientIp, extraHeaders = {}) {
